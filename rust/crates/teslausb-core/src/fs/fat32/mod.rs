...
//! [`geometry::Fat32Geometry`]'s [`crate::fs::geometry::Geometry::region_at`]
//! method to route an incoming
//! byte-offset to the correct synthesizer module.
//!
//! Phase 2.1 ships only [`geometry`]; subsequent increments fill
//! in the others.
//!
//! ## Spec reference
//!
