...
def get_storage_health():
    ...
    Returns:
        dict: Health information with keys:
            ...
            - fsck_status: dict with filesystem check information
    """
    from . import fsck_service
    ...
    for partition_num in [1, 2]:
        ...
        if last_check:
            health['fsck_status'][partition_name] = {
                ...
                'age_hours': last_check['age_hours']
            }

            # Warn if filesystem check is old (>30 days) or never checked
